...
from .serializers import GenericFileUpload, GenericFileUploadSerializer,MessageSerializer,MessageAttachmentSerializer,Message,MessageAttachment
...
def handleRequest(serializerData):
    ...
    print("ll",settings.SOCKET_SERVER)
    try:
